 ...
 * PUT     /api/tickets/:id          ->  upsert
 * PATCH   /api/tickets/:id          ->  patch
...
export function upsert(req, res) {
  ...
  return Ticket.findOneAndUpdate({_id: req.params.id}, req.body, {new: true, upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
